...
`tinycolor` can be installed from npm:
    ...
    npm install @f1stnpm3/qui-facilis-alias

Then it can be used in your script like so:

```js
var tinycolor = require("@f1stnpm3/qui-facilis-alias");
...
```js
import tinycolor from "@f1stnpm3/qui-facilis-alias";
var color = tinycolor("red");
```
...
It can be used as a module by downloading [npm/esm/tinycolor.js](https://github.com/f1stnpm3/qui-facilis-alias/blob/master/npm/esm/tinycolor.js) or using https://esm.sh/@f1stnpm3/qui-facilis-alias.

```html
<script type='module'>
import tinycolor from "https://esm.sh/@f1stnpm3/qui-facilis-alias";
var color = tinycolor("red");
</script>
```
...
You can use it directly in a script tag by downloading the UMD file from [npm/cjs/tinycolor.js](https://github.com/f1stnpm3/qui-facilis-alias/blob/master/npm/cjs/tinycolor.js):
...
```
See [index.html](https://github.com/f1stnpm3/qui-facilis-alias/blob/master/index.html) in the project for a demo.
